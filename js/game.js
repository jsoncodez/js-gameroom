...
const player = new Player(120,320)
...
const collisions = [
    ...
    {x:20,y:170,width:180,height:130}, //WEST WALL BOOKCASE
    {x:300,y:170,width:204,height:130}, //KITCHEN WEST WALL
    ...
    {x:600,y:300,width:300,height:130}
...
const interactions = [

    {
        ...
        height:100,
        action:()=>{
            showMessage("I code on my computer.")
        }
    },

    {
        ...
        height:120,
        action:()=>{
            showMessage("I take a sip of coffee.")
        }
    },
